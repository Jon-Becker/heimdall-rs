...
impl Opcode {
    ...
    pub fn new(code: u8) -> Opcode {
        match code {
            ...
            0x54 => Opcode { code, name: "SLOAD", mingas: 100, inputs: 1, outputs: 1 },
            0x55 => Opcode { code, name: "SSTORE", mingas: 100, inputs: 2, outputs: 0 },
            ...
            0xa1 => Opcode { code, name: "LOG1", mingas: 750, inputs: 3, outputs: 0 },
            0xa2 => Opcode { code, name: "LOG2", mingas: 1125, inputs: 4, outputs: 0 },
            0xa3 => Opcode { code, name: "LOG3", mingas: 1500, inputs: 5, outputs: 0 },
            0xa4 => Opcode { code, name: "LOG4", mingas: 1875, inputs: 6, outputs: 0 },
