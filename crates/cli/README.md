...
`heimdall strings <TARGET>` prints consecutive printable ASCII characters (`0x20`–`0x7e`),
...
```sh
heimdall strings 0x48656c6c6f00776f726c64
# Hello
# world
...
This scans all bytes, including instructions and metadata, like Unix `strings`.
Printable opcode bytes may appear in the output; it does not reconstruct strings
assembled at runtime or decode Unicode.
